...
SOR::SOR(double eps, double max_it, double w, const std::array<bool,4>& p_0_boundary)
	: Pressure_solver(eps, max_it, p_0_boundary), m_w{w}{}

//void SOR::run_it_step(Array2D& p, const Array2D& RHS, const std::array<int, 2> size) const
void SOR::run_it_step(Discretization& discr) const
{
