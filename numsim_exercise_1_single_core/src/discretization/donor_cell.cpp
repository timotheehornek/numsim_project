...
Donor_cell::Donor_cell(const std::array<int, 2>& nCells, const std::array<double, 2>& physicalSize, const bool obstExist, const std::array<int, 4>& obstacle_pos, const double re, const std::array<double, 2>& g, const double alpha)
	: Discretization(nCells, physicalSize, obstExist, obstacle_pos, re, g), m_alpha{alpha} {};
