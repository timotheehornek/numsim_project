...
class Donor_cell : public Discretization
{
private:
	const double m_alpha;

public:
	Donor_cell(const std::array<int, 2> &nCells, const std::array<double, 2> &physicalSize, const double re, const std::array<double, 2> &g, Message_passer_2D &MP, const double alpha);
